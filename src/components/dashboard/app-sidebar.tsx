...
export const EMenuIcon = ({ width = "182", height = "32", className }: { width?: string | number, height?: string | number, className?: string }) => (
  <svg width={width} height={height} viewBox="0 0 91 16" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
